 ...
 * 
 */
public class MediaRecorderNative extends MediaRecorderBase implements
	...
	public MediaPart startRecord() {
		...
		if (mMediaObject != null) {
			...
			// cmd +=
			// String.format("addcmd = %s; "," -vf \"transpose=1,crop=480:480:0:0\" ");
			UtilityAdapter.FilterParserAction(cmd,
					UtilityAdapter.PARSERACTION_START);
	...
	protected void onStartPreviewSuccess() {
		if (mCameraId == Camera.CameraInfo.CAMERA_FACING_BACK) {
			UtilityAdapter.RenderInputSettings(640, 480, 0,
					UtilityAdapter.FLIPTYPE_NORMAL);
		} else {
			UtilityAdapter.RenderInputSettings(640, 480, 180,
					UtilityAdapter.FLIPTYPE_HORIZONTAL);
		}
		UtilityAdapter.RenderOutputSettings(480, 480, mFrameRate,
				UtilityAdapter.OUTPUTFORMAT_YUV
