...
public class MediaObject implements Serializable {
	...
	public MediaObject(String key, String path, int videoBitrate) {
		...
		this.mOutputObjectPath = mOutputDirectory + File.separator + mKey
				+ ".obj";
	...
	public String getObjectFilePath() {
		if (StringUtils.isEmpty(mOutputObjectPath)) {
			...
			String obj = mOutputDirectory + File.separator + f.getName()
					+ ".obj";
	...
	public MediaPart buildMediaPart(int cameraId) {
		...
		mCurrentPart.mediaPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + ".v";
		mCurrentPart.audioPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + ".a";
		mCurrentPart.thumbPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + ".jpg";
	...
	public MediaPart buildMediaPart(int cameraId, String videoSuffix) {
		...
		mCurrentPart.index = mMediaList.size();
		mCurrentPart.mediaPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + videoSuffix;
		mCurrentPart.audioPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + ".a";
		mCurrentPart.thumbPath = mOutputDirectory + File.separator
				+ mCurrentPart.index + ".jpg";
