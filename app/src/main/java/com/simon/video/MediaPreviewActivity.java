...
import com.simon.video.common.AssertService;
import com.simon.video.common.CommonIntentExtra;
import com.simon.video.common.POThemeSingle;
import com.simon.video.library.DeviceUtils;
import com.simon.video.library.FileUtils;
import com.simon.video.library.MediaObject;
import com.simon.video.library.MediaThemeObject;
import com.simon.video.library.StringUtils;
import com.simon.video.ui.ThemeGroupLayout;
import com.simon.video.ui.ThemeSufaceView;
import com.simon.video.ui.ThemeView;
import com.simon.video.utils.ConvertToUtils;
import com.simon.video.utils.IsUtils;
import com.simon.video.utils.ThemeHelper;
import com.simon.video.utils.ToastUtils;
				...
				mAuthorBitmapPath = ThemeHelper
						.updateVideoAuthorLogo(
								...
								getString(R.string.record_camera_author,
										getString(R.string.app_name) + " Simon"),
								false);
				return result;
			}
